    ...
    <div className="hero min-h-screen  mt-[75px] flex justify-center items-center py-10">
      ...
      <div className="hero-content w-full flex-col lg:flex-row gap-10">
        ...
        <div className="card w-full lg:w-1/2 py-10 shadow-lg border-2">
          <h1 className="text-3xl  ms-10 font-bold text-blue-600">
            Create Account
          </h1>
          <p className="ms-10  text-green-900 text-sm">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="card-body ">
            ...
            <div className="form-control ">
              ...
              {errors.password?.type === "pattern" && (
                <p className="text-red-600 text-sm">
                  password must have one uppercase & one special characters
                </p>
              )}
            </div>
            ...
            <div className="form-control ">
              <label className="label relative">
                ...
                >
                  {showTwo ? <FaEye></FaEye> : <FaEyeSlash></FaEyeSlash>}
                </span>
              </label>
              <input
